...
This is used anywhere you need to "divide" under a modulus (since normal division isn't well-defined mod `p`) — e.g. computing `nCr % mod` via precomputed factorials, see [[2026-06-13-Combinatorial-Ideas-to-Know]].
