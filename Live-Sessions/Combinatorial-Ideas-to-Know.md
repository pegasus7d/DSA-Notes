---
tags: [live-session, maths, binary-exponentiation, modular-arithmetic]
status: In Progress
...
*In progress — more topics from this session (combinatorics ideas beyond exponentiation) to be added as the session continues.*
